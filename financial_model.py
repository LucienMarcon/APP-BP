...
class Financing:
    ...
    def __init__(self, inputs, total_investment_cost):
        ...
        self.equity_needed = 0 # Sera calculé via CapexSummary
...
class CashflowEngine:
    ...
    NOW ACCEPTS CAPEX SUMMARY.
    """
    def __init__(self, 
                 general: General, 
                 construction: Construction, 
                 financing: Financing, 
                 capex_summary: CapexSummary, # Ajouté
        ...
        # Calculate Equity Needed based on CAPEX Summary Logic
